dependencies {
    ...
    api(project(":devops-scm-provider:devops-scm-provider-git:devops-scm-provider-gitlab"))
    api(project(":devops-scm-provider:devops-scm-provider-git:devops-scm-provider-gitee"))
    api(project(":devops-scm-provider:devops-scm-provider-git:devops-scm-provider-bkcode"))
